  ...
  return (
    <div className="tool-section app-scrollbar flex h-full flex-col gap-5 overflow-y-auto p-5">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-primary-700 bg-primary-600 py-3 font-medium text-white shadow-sm transition-colors hover:bg-primary-700 disabled:opacity-50"
      >
        {isProcessing ? (
          '计算中...'
        ) : (
