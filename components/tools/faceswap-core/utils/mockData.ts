...
export const MODELS: ModelFacePack[] = [
  {
    ...
    skinStats: { mean: [0.6, 0.55, 0.5], std: [0.1, 0.1, 0.1] }, // RGB approx
  },
  {
    id: 'm2',
    name: 'Model: Studio',
    ...
    triangles: MOCK_TRIANGLES,
    skinStats: { mean: [0.7, 0.65, 0.6], std: [0.1, 0.1, 0.1] }, // Lighter skin
  }
];
...
export const SOURCES: SourceFacePack[] = [
  {
    ...
    skinStats: { mean: [0.4, 0.4, 0.5], std: [0.1, 0.1, 0.1] }, // darker, cooler
  },
  {
    id: 's2',
    name: 'Source: Vintage',
    ...
    skinStats: { mean: [0.6, 0.5, 0.4], std: [0.1, 0.1, 0.1] },
  },
  {
    id: 's3',
    name: 'Source: Bright',
    ...
    skinStats: { mean: [0.7, 0.7, 0.7], std: [0.1, 0.1, 0.1] },
  }
];