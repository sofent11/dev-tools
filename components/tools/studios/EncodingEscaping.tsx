...
import { Type, FileArchive, Link, Code, Eye, FileCode, ScanText } from 'lucide-react';
...
const subTools: SubTool[] = [
  ...
  { id: 'hex-text', name: 'Hex 字节转文本', description: '按字符编码解码十六进制字节', icon: FileCode, component: HexTextDecoder },
  { id: 'unicode-inspector', name: 'Unicode 字符检查器', description: '码点、字符名、区块和 Emoji 序列分析', icon: ScanText, component: UnicodeInspector },
