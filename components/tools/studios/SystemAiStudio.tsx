...
import { Fingerprint, Binary, Wand2, WalletCards, Terminal, CalendarClock, Sparkles, Clock, Globe } from 'lucide-react';
...
const subTools: SubTool[] = [
  ...
  { id: 'ai', name: 'AI 代码助手', description: '智能编程问答与上下文提示', icon: Sparkles, component: AiAssistant },
...
export const SystemAiStudio: React.FC = () => {
  return (
    <TabbedToolbox
      title="智能计算、数据生成与时间工坊"
      description="集成高级随机数/UUID/API Mock 数据生成、Cron/Chmod Linux 工具、AI 编程助理及世界多维时区换算"
      tools={subTools}
      defaultTab="uuid"
    />
  );
