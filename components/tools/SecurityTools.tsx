...
import {
  ...
  generateUnbiasedPassword,
} from './security/passwordCore';

export { buildPasswordCharset, generateUnbiasedPassword } from './security/passwordCore';
...
export { SmCryptoSuiteTool } from './security/SmCryptoSuiteTool';
